...
# APX (AD-47/FR-51): the database URL is read from the environment, never stored
# in source. Story 1.1 ships an EMPTY migration environment — no schema, no
# migration scripts. The frozen payload schema is story 1.3; the fail-closed
