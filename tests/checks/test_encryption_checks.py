...
must hold on the real tree AND fire on a deliberately violating fixture — a plaintext
sensitive column, an encrypted text index, a warn-only gate, a gate missing a layer — and
fail closed on an unparseable file. A guard that cannot fail is worthless.
"""
