...
| 12 | "Recall over precision" is a number, not a slogan | **Random sampling with a confidence bound.** Sample 200 of 1 400 discarded: "200 checked, none relevant; with 95% confidence at most 1.5% of the discarded set — about 21 pieces — is relevant." Moving the line is priced: "move it here and you read 400 more pieces, and the bound tightens from X% to Y%." ⚠️ **Corrected 21 July 2026** — this originally read "risk of having missed a relevant document < 1.5%", which is false: sampling bounds *prevalence*, not the probability that nothing was missed. Use a hypergeometric bound, not the binomial rule of three. See `../../planning-artifacts/prds/prd-apx-mvp-2026-07-20/review-adversarial.md`. |
